...
//$perPage = (isset($_GET['per-page']) && (
  //  ($_GET['per-page'] <= 50 ? $_GET['per-page'] : 5)
//));
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-2 mb-5 mt-5">
                ...
                <button type="button" class="btn btn-secondary float-right"><i class="bi bi-printer"></i> Imprimir</button>
            </div>
